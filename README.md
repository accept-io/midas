...
| [docs/examples/control-plane.md](docs/examples/control-plane.md)                         | Self-contained control-plane example bundles: plan/apply, Surface/Profile approval, evaluate, idempotency/conflict checks, and evidence integrity         |
| [examples/control-plane/](examples/control-plane/)                                       | Five reviewer-friendly YAML bundles covering accepted, escalated, and request-clarification outcomes without relying on demo seed data                    |
| [docs/explorer.md](docs/explorer.md)                                                     | Explorer sandbox: usage, endpoints, auth, envelope inspector                                                                                             |
| [docs/architecture/drift-analytics.md](docs/architecture/drift-analytics.md)             | Drift Analytics design, current backend-backed compact chart path, seeded reviewer validation, and implementation boundaries                              |
| [docs/control-plane.md](docs/control-plane.md)                                           | Apply, plan, surface lifecycle, versioning                                                                                                               |
| [docs/core/platform-contract.md](docs/core/platform-contract.md)                         | Core MIDAS API, YAML resource, runtime evaluation, evidence, and eventing contract                                                                        |
